...
// ANSWER: 
//The object in the first function is constant and does not change and sends in the same string to both, returning the same thing which takes up the same amount of space. The second function is a little different but still linear but will give you different strings since it's replacing what's in the string but still returning.
